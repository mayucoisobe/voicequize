...
export default function SplashScreen({ finishLoading }) {
  ...
  const animation = () => {
    ...
    loader
      ...
      .to('.triangle', { y: '-6.5rem', rotation: 30, duration: 0.35, ease: 'power4.out' })
      ...
      .to('.ractan', { scaleY: '.6', transformOrigin: '0% bottom', duration: 0.3 }, '0.37')
      .to('.ractan', { scaleY: '1' }, '>')
      .fromTo(
        '.splashTtlInner',
      ...
      .to('.ractan', { x: '-15rem', scale: 1.5, transformOrigin: '50% 50%', rotate: '-360deg', duration: 1.3 }, '>');
  };
